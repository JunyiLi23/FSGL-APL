configs2 = {
    "cora": {
        "zero-shot": {
            ...
            "answer-format": "Give your answer together with a confidence score ranging from 0 to 100, in the form of a python dict like [{\"answer\":<answer_here>, \"confidence\": <confidence_here>}]. The confidence represents the probability of your answer to the question."
        },
        "few-shot": {
            "examples": [
